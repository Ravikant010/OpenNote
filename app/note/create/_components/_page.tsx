  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-background to-secondary/20">
      ...
      <header className="fixed top-0 left-0 right-0 bg-background/80 backdrop-blur-lg border-b border-border/50 z-50">
        <button
          type="button"
          className="py-2 px-6 text-sm bg-indigo-50 dark:bg-indigo-500 dark:text-white text-indigo-500 rounded-full cursor-pointer font-semibold text-center shadow-xs transition-all duration-500 hover:bg-indigo-100 border-2"
        >
          Back
        </button>
